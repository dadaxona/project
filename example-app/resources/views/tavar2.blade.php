  ...
  <div class="card-block tab-icon">
          <div class="col-12">
              <ul class="nav nav-tabs md-tabs " role="tablist">
                  <li class="nav-item">
                      <a class="nav-link active" data-toggle="tab" href="#home7" role="tab" aria-expanded="true"><i class="icofont icofont-home"></i>Товар склад</a>
                      <div class="slide"></div>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" data-toggle="tab" href="#profile7" role="tab" aria-expanded="false"><i class="icofont icofont-ui-user "></i>Товар списа</a>
                      <div class="slide"></div>
                  </li>
                  <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#settings7" role="tab" aria-expanded="false"><i class="icofont icofont-ui-settings"></i>0 Астатка</a>
                    <div class="slide"></div>
                </li>
              </ul>
                  ...
                  <div class="tab-pane active" id="home7" role="tabpanel" aria-expanded="true">
                      ...
                      <div class="row">
                        <div class="col-9 mt-0">
                          ...
                          <button class="btn btn-primary p-1 pr-2" id="iddr2">
                          ...
                          <a class="btn btn-success m-0 p-1 pr-2" href="#" onclick="event.preventDefault(); document.getElementById('ddrastat').submit();">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-upload" viewBox="0 0 16 16">
                              <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                              <path d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708l3-3z"/>
                            </svg>
                          ...
                          <form action="{{ route('exports9') }}" method="GET" id="ddrastat">
                          </form>
                        </div>
                        <div class="col-3 mt-0">                       
                          <div class="d-flex">
                            <input class="form-control mx-2" style="width: 37%" type="date" id="dateearche">
                            <input class="form-control" style="width: 37%" type="date" id="date2earche">                           
                          </div>                          
                        </div>
                      </div>
                      </div>
...
<div id="tavar2">
    <div class="modal-header">
      ...
      <form id="TavarFormTable" action="{{ route('store3create') }}" method="POST">
        @csrf
...
$( function() {
    ...
    $( "#nazadclickedok" ).on( "click", function() {
      ...
      function nolastatka(query = '')
      {
          $.ajax({
              ...
              success:function(data)
              {
                $('#nolastatka').html(data.table_data);
              }
          });
      }
      nolastatka();
  ...
  function datasearche(date2earche = '')
  {
    var dateearche = $("#dateearche").val();
    $.ajax({
      url:"{{ route('datasearche') }}",
      method:'GET',
      dataType:'json',
      data:{
        dateearche: dateearche,
        date2earche: date2earche
      },
      dataType:'json',
      success:function(data)
      {
  ...
  $(document).on("change", "#date2earche", function(){
    var date2earche = $(this).val();
    datasearche(date2earche);
  });
