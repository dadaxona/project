            ...
            <div class="extr25552 scrolll2">
                  <div class="row">
                    ...
                    <div class="col-3 mt-3 ">
                        <a class="d-flex"><h5>Клент имя:</h5> <h5 class="clnam mx-3"></h5></a>
                    </div>                    
                </div>
    ...
    <div class="card col-4">
        <div class="card-header">
            ...
            <div class="row">
                ...
                <div class="col-2"></div>
                <div class="col-5 row">
                    <button type="button" class="btn btn-primary p-2" onclick="addPost()">Клиент Яратиш</button>
                </div>
            </div>
        </div>
        <div class="table-responsive mailbox-messages">
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="d-flex p-3 pb-5">
        <button type="button" class="btn btn-danger mr-2" data-bs-dismiss="modal" id="nazadsd">Назад</button>
    ...
    $(document).on('click', '#bankteng', function(){
        ...
        $("#oplata").on('click', function(){
            ...
            if(checks == 1){
                ...
                if(karzs < 0){
                    toastr.error("Тулов киймати ортикча. Текшириб кайтадан уриниб коринг");
                }
                if(karzs == 0){
                    if(clentra == null){
                        $.ajax({
