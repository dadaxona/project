...
<div class="card">
  <h3 class="text-center">Mrt malumotlar</h3>
    <div class="card-header">
        <form action="{{ route('mrtstor') }}" method="POST" id="userForm">
            @csrf
            <div class="row">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="delForm" action="{{ route('del2post') }}" method="POST">
              @csrf
