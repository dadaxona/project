...
class AuthController extends Controller
{
    ...
    {
        $data = Usere::orderBy('id', 'DESC')->paginate(20);
        $datae = Usta::all();
        $brends = Drektor::where('id','=',Session::get('IDIE'))->first();
        return view('mijoz', [
            'collection'=>$datae,
    ...
    {
        $data = Usere::orderBy('id', 'DESC')->where('tel', "LIKE", '%'.$request->tel.'%')->paginate(50);
        $collection = Usta::all();
        $brends = Drektor::where('id','=',Session::get('IDIE'))->first();
        return view('mijoz', [
            'brends'=>$brends,
    ...
    {
        $data = Usere::orderBy('id', 'DESC')->where('name', "LIKE", '%'.$request->mijozsearch.'%')->paginate(50);
        $collection = Usta::all();
        $brends = Drektor::where('id','=',Session::get('IDIE'))->first();
        return view('mijoz', [
            'brends'=>$brends,
